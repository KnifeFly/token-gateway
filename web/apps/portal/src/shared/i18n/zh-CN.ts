...
export const portalCopy = {
  ...
  playground: {
    title: "操练场",
    description: "按模型结构定义生成请求字段，执行客户项目范围内的安全校验。",
    modelLabel: "模型",
    modeLabel: "模式",
    streamLabel: "流式",
    streamHint: "仅校验开关和路由，不调用上游。",
    runAction: "运行校验",
    schemaTitle: "结构字段",
    resultTitle: "安全结果",
    debugTitle: "调试摘要",
    requiredBadge: "必填",
    optionalBadge: "可选",
    fieldPlaceholder: "按结构填写测试值",
    noSchemaFields: "当前模型没有可填写字段",
    statusReady: "就绪",
    statusWarning: "需处理",
    statusInvalid: "未通过",
    noResult: "暂无运行结果",
    ...
    usageLabel: "Token 估算",
    guardrailTitle: "安全边界",
    guardrailItems: ["不保存客户密钥", "不展示上游凭证", "不返回原始提示词或响应"]
  },
  apiKeys: {
    title: "API 密钥",
    createTitle: "创建密钥",
