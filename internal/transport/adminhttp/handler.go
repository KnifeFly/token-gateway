...
func (h *Handler) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/admin/v1/usage-logs", h.withSession(h.listUsageLogs))
	mux.HandleFunc("GET /api/admin/v1/usage-logs/", h.withSession(h.usageLogByRequestID))
