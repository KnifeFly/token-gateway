...
- `docs/plan/16-p5-provider-protocol-compatibility.md` 到 `docs/plan/20-p9-customer-acceptance.md` 作为剩余产品能力和客户验收收口规划。
...
- P5-P9 只覆盖当前明确要做的剩余能力和验收收口；控制面 RBAC/审计平台、复杂财务/发票闭环、对象存储、完整 Realtime、生产级 Observability 扩展、WASM/动态插件不进入当前路线。
...
- `docs/tasks.md` 能直接指导 P5-P9 后续开发和验收收口。
- M0-M9 的先后关系与最终设计包一致。
- P0-P9 能直接指导设计差距补齐、商用硬化、发布候选验收、剩余产品能力建设和客户验收收口，且每个阶段都有可验证的完成标准。
